...
//Serverul o prelucreaza si ii da un raspuns
//Request si response
const express = require('express');
const app = express();
const http = require('http').createServer(app);
const io = require('socket.io')(http); // conectam front de back prin webscokets


const PLAYER_DIM = 32;
// deschidere server la portul 5000
http.listen(5000, function(){
    console.log('[SERVER STARTED AT PORT 5000]');
})


//Raspuns pentru server in urma request-ului
app.get('/', function(request, response){
    response.sendFile(__dirname + '/index.html');
})
//dirname contine path-ul fisierului in care ne aflam
